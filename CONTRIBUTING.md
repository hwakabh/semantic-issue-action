...
## Bug Reports
For bug reports or requests [submit an issue](https://github.com/hwakabh/semantic-issue-action/issues).
...
## Pull Requests
The preferred way to contribute is to fork the [main repository](https://github.com/hwakabh/semantic-issue-action) on GitHub.
...
1. Fork the [main repository](https://github.com/hwakabh/semantic-issue-action).  Click on the 'Fork' button near the top of the page.  This creates a copy of the code under your account on the GitHub server.

2. Clone this copy to your local disk:
```shell
$ git clone git@github.com:${YOUR_USERNAME}/semantic-issue-action.git
$ cd semantic-issue-action
```
...
6. Finally, go to the web page of your fork of the `semantic-issue-action` repo and click 'Pull Request' to send your changes for review.
